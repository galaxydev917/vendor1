	...
	<div class="col-sm-12">
		...
		<table id="owner_grid" class="table table-condensed table-hover table-striped" cellspacing="0" data-toggle="bootgrid">
			<thead>
					...
					<th data-column-id="first_name" data-identifier="true" data-type="string" data-visible="false">Img src</th>						
					<th data-column-id="product_name" style="display:flex; justify-content:center; align-items:center;">Product Name</th>
					<th data-column-id="last_name">Description</th>
		...
		<div class="modal-dialog" style="width:500px;">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" value="<?php echo $vendorid; ?>" name="add_vendorid" id="add_vendorid">
						...
						<div class="row">
							...
							<div class="col-xs-6 col-sm-6 col-md-6">
								...
								<div id="add_targetLayer">
									<img id="add_PreviewImg" src="#" style="width:200px; height:150px;" />
								</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<input type="hidden" value="<?php echo $vendorid; ?>" name="edit_vendorid" id="edit_vendorid">
